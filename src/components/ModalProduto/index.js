...
function ModalProduto({ onClickForaDoModal, onClickStatusModal, onClickStatusModalPix, onClickAmazon, img, nome, preco }) {
    return (<ContainerForaDoModal onClick={onClickForaDoModal}>
        <ContainerModal>
            ...
            <div className="botoes-doacao">
                ...
                <Button informacao="Presentear pela Amazon" onClick={onClickAmazon} />
            </div>
        </ContainerModal>
